...
public class HostImplement implements Host {
	...
	public int modifyBook() {
		...
		i = Integer.parseInt(Console.input()) - 1;
		Book bookOnModification;
	
			bookOnModification = Shelf.shelf.get(i);
		
		System.out.println("제목");
		bookOnModification.setTitle(Console.input());
		System.out.println("저자");
		bookOnModification.setWriter(Console.input());
		System.out.println("가격");
		bookOnModification.setPrice(Integer.parseInt(Console.input()));
