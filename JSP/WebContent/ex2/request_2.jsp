...
<body>
	...
	.getParameterValues(String name) : name에 해당하는 파라미터 값들을 String 배열로 가져온다.<br/>
	<pre>
	input type이 'submit'인 버튼을 클릭시 from 태그의 method방식은 get 방식과 post방식이 있다.
	.get 방식 : 요청 url(form action명)의 뒷부분에 물음표(?)와 함께 파라미터를 붙여서 전송<br/>
				?이름1=값1&이름2=값2...<br/>
	.post 방식 : 요청 url(form action명)에 파라미터를 붙이지 않고 전송
	</pre>
	<form action="requestParam.jsp" method="get">
		이름 : <input type="text" name="name" size="10"><br/>
		아이디 : <input type="text" name="id" size="10"><br/>
		비밀번호 : <input type="password" name="pwd" size="10"><br/>
		취미 : <input type="checkbox" name="hobby" value="read">독서<input type="checkbox" name="hobby" value="cook">요리<input type="checkbox" name="hobby" value="jog">조깅<input type="checkbox" name="hobby" value="swimming">수영
