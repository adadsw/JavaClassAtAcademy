...
책 목록 없음
${addBookResult}
	<input type="button" value="책 추가" onclick="window.location='hostBookAddForm'">
</c:if>

<%-- 책 있는 경우 --%>

<c:if test="${bookList != null}">
	<form method="post" action="hostBookDeletePro" onsubmit="return bookdeletewarning()">
		<table>
			<tr>
				<td>
				</td>
			...
			<c:forEach var="books" items="${bookList}">
				<tr>
					...
					<td>
						<a href="hostBookModifyForm?book_code=${books.book_code}">${books.title}</a>
					</td>
					<td>
						${books.writer_name}
					</td>
